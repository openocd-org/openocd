...
/*
 * The size of {dmi-address} in {dtm-dmi}.
 */
...
/*
 * busy: A DMI operation was attempted while a prior DMI operation was still in
 ...
 * is implemented.
 */
#define CSR_DCSR_PELP_OFFSET                0x12ULL
#define CSR_DCSR_PELP_LENGTH                1ULL
#define CSR_DCSR_PELP                       0x40000ULL
/*
 * NO_LP_EXPECTED: No landing pad instruction expected.
 */
#define CSR_DCSR_PELP_NO_LP_EXPECTED        0
/*
 * LP_EXPECTED: A landing pad instruction is expected.
 */
#define CSR_DCSR_PELP_LP_EXPECTED           1
